...
export function NewNoteCard() {
	return (
		<Dialog.Root>
			<Dialog.Trigger className='rounded-md p-5 flex flex-col bg-slate-700 gap-3 text-left outline-none hover:ring-2 hover:ring-slate-500 focus-visible:ring-2 focus-visible:ring-lime-400'>
